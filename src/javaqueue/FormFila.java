...
{
    Queue<Pessoa> filaNormal = new ArrayDeque<Pessoa>(); //Queue coloca a pessoa na fila e Dequeue tira
    Queue<Pessoa> filaPreferencial = new ArrayDeque<Pessoa>(); //Queue coloca a pessoa na fila e Dequeue tira
    int aux=1;
    ...
    private void btnAtenderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAtenderActionPerformed
        if(!filaPreferencial.isEmpty()) 
        {
            ...
            {
                Pessoa p = new Pessoa();
                p = filaPreferencial.remove();// dequeue
